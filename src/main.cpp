...
static String _authmode_to_string(const wifi_auth_mode_t authmode) {
    switch (authmode) {
        ...
        default: return "(" + ArithmeticToString(static_cast<int>(authmode)) + ")";
    }
}
static String _error_to_string(const wifi_err_reason_t reason) {
    switch (reason) {
        ...
        default: return "(" + ArithmeticToString(static_cast<int>(reason)) + ")";
    }
}
